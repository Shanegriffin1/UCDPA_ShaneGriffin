...
#mex_pop.sort_values(by= 'Population', ascending = True, inplace= False)
#print(mex_pop)
...
#mex_stats.sort_values(by= 'Population', ascending= True, inplace= True)
print(mex_stats)
...
sns.scatterplot(ax=axes[1], x=mex_stats['TIME'], y=mex_stats['Population'])
